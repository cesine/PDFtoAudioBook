...
import ca.openlanguage.pdftoaudiobook.provider.AudioBookLibraryContract.DocumentColumns;
...
public class AudioBookLibraryDatabase extends SQLiteOpenHelper {
    ...
    private static void createDocumentsSearch(SQLiteDatabase db){
    	...
    	db.execSQL("CREATE VIRTUAL TABLE " + Tables.DOCUMENTS_SEARCH 
    			+ " USING fts3("
    	 ...
    	 * whcih contains some info about the document
    	 */
    	db.execSQL("CREATE TRIGGER " + Triggers.DOCUMENTS_SEARCH_INSERT 
    	 ...
    	 */
    	db.execSQL("CREATE TRIGGER "+ Triggers.DOCUMENTS_SEARCH_DELETE + " AFTER DELETE ON "
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE " + Tables.DOCUMENTS + " (" 
				+ Documents._ID + " INTEGER PRIMARY KEY AUTIOINCREMENT,"
