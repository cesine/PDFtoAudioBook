...
public class EditDocumentDetails extends Activity {
    ...
    private void saveToDatabase(){
        ...
        //inspired from noteeditor
        ContentValues values = new ContentValues();
        values.put(DocumentTableMetadata.DOCUMENT_TITLE, mDocTitleEditText.getText().toString() );
        values.put(DocumentTableMetadata.DOCUMENT_AUTHOR, mDocAuthorEditText.getText().toString());
